...
func BuildCommands(mainCommand commands.BaseCommand, config *config.Config) error {
	// svc := upapi.APIClient

	// Servers
	// serverCommand := commands.BuildCommand(
	// 	server.BaseServerCommand(),
	// 	mainCommand,
	// 	config,
	// )

	// commands.BuildCommand(server.ListCommand(svc), serverCommand, config)
	// commands.BuildCommand(server.PlanListCommand(), serverCommand, config)
	// commands.BuildCommand(server.ShowCommand(svc, svc), serverCommand, config)
	...
	// commands.BuildCommand(server.CreateCommand(svc, svc), serverCommand, config)
	...
	// // Networks
	// networkCommand := commands.BuildCommand(
	// 	network.BaseNetworkCommand(),
	// 	mainCommand,
	// 	config,
	// )

	// commands.BuildCommand(network.CreateCommand(svc), networkCommand, cfgFn())
	// commands.BuildCommand(network.ListCommand(svc), networkCommand, config)
	...
	// // Account
	// accountCommand := commands.BuildCommand(
	// 	account.BaseAccountCommand(),
	// 	mainCommand,
	// 	config,
	// )
	// commands.BuildCommand(account.ShowCommand(svc), accountCommand, config)
